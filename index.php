                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Our selling service helps you list and sell your property quickly and efficiently. We provide expert guidance, market analysis, and professional support to ensure you get the best value for your property.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Find the perfect rental property with ease. Our rental service offers a wide range of options, from apartments to villas, with personalized support to meet your needs.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>List your property with us to reach a wide audience. We ensure your property is showcased effectively, attracting the right buyers or tenants.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Invest in real estate with confidence. Our legal investment services ensure all transactions are secure, transparent, and compliant with regulations.</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>We are recognized for our excellence in real estate services, trusted by clients for our reliability and professionalism.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Our team delivers high-quality services, ensuring every client receives the best experience and results.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Our agents are highly skilled and knowledgeable, providing expert advice and support throughout your real estate journey.</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>We start by understanding your needs and goals through a detailed discussion to tailor our services to your requirements.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>We carefully review all documents and details to ensure everything is accurate and ready for the next steps.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Finalize your purchase or rental with ease, supported by our team to ensure a smooth and hassle-free process.</p>
                        </div>
                    </div>
                </div>
            </div>
