			...
			<ul>
				...
				<li class="submenu">
					<a href="#"><i class="fe fe-bar-chart"></i> <span> Reports </span> <span
							class="menu-arrow"></span></a>
					<ul style="display: none;">
						<li><a href="reports/property_report.php"> Property Report </a></li>
						<li><a href="reports/user_report.php"> User Report </a></li>
						<li><a href="reports/agent_performance.php"> Agent Performance </a></li>
					</ul>
				</li>
